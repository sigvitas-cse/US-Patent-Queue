    ...
    <div className="bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 min-h-screen">
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-gray-800 mb-6 text-center">About US Patent Quew</h2>
          <p className="text-lg text-gray-600 mb-6">
            US Patent Quew is your trusted platform for accessing comprehensive patent data and staying updated with the latest
